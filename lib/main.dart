  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData.dark().copyWith(
        scaffoldBackgroundColor: const Color(0xFF0D0F19),
        ...
        textTheme: const TextTheme(
          ...
          bodyLarge: TextStyle(fontSize: 16, color: Color(0xFFBDC6C7)),
        ),
      ),
      home: const FlightIntroScreen(),
      routes: {
...
class FlightIntroScreen extends StatefulWidget {
  const FlightIntroScreen({Key? key}) : super(key: key);

  @override
  State<FlightIntroScreen> createState() => _FlightIntroScreenState();
}

class _FlightIntroScreenState extends State<FlightIntroScreen>
  ...
  void initState() {
    ...
    _planeAnimation = Tween<double>(begin: 300, end: -200).animate(
    ...
    Future.delayed(const Duration(seconds: 2), () {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (_) => const LogoAnimationScreen()),
      );
    });
  }
...
class GlobeJetPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Paint jetPaint = Paint()..color = const Color(0xFFD4AF37);
